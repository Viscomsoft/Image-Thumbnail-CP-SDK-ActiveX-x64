...
,"Slow Speed, High Quality","Very Slow Speed, Best Quality "});
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            if (cboExportImageType.SelectedIndex==0)
                    this.saveFileDialog1.Filter = "BMP File (*.bmp)|*.bmp";
            else if (cboExportImageType.SelectedIndex == 1)
                this.saveFileDialog1.Filter = "JPEG File (*.jpg)|*.jpg";
            else if (cboExportImageType.SelectedIndex == 2)
                this.saveFileDialog1.Filter = "TIF File (*.tif)|*.tif";
            else if (cboExportImageType.SelectedIndex == 3)
                this.saveFileDialog1.Filter = "PNG File (*.png)|*.png";
            else if (cboExportImageType.SelectedIndex == 4)
                this.saveFileDialog1.Filter = "GIF File (*.gif)|*.gif";

                
            if (this.saveFileDialog1.ShowDialog(this) == DialogResult.OK)
             {
                 axImageThumbnailCP1.ExportImageClipByIndex((short)iCurIndex, saveFileDialog1.FileName);
